...
import (
	sap_api_caller "sap-api-integrations-accounting-document-creates/SAP_API_Caller"
	sap_api_input_reader "sap-api-integrations-accounting-document-creates/SAP_API_Input_Reader"
	"sap-api-integrations-accounting-document-creates/config"
...
func main() {
	...
	caller.AsyncPostAccountingDocument(
		item,
		accepter,
	)
}
